...
public class VehicleController {
        ...
        public ResponseEntity getVehicles(@QueryParam("categoryName") String categoryName,
                                          @QueryParam("pickupDate") ChronoLocalDate pickupDate,
                                          @QueryParam("dropoffDate") ChronoLocalDate dropoffDate,
